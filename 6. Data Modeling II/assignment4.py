...
# Create DecisionTree
dt = tree.DecisionTreeClassifier(max_depth=max_depth, random_state=2)
...
benchmark(dt, X_train, X_test, y_train, y_test, 'DecisionTree')
drawPlots(dt, X_train, X_test, y_train, y_test, 'DecisionTree')
